...
const ContactForm = () => {
  ...
  return (
    ...
    <div className='contact-form-wrapper'>
      <motion.div variants={fadeIn('down',0.3)} initial="hidden" whileInView={'show'} viewport={{once:false, amount:0.3}} className='contact-container'>
        <motion.div variants={fadeIn('left',0.6)} initial="hidden" whileInView={'show'} viewport={{once:false, amount:0.3}} className='contact-info'>
          <h1>Let's Work Together</h1>
          <p>Nice hearing from you!</p>
          <img src={require('../../assets/Personal_email.png')} alt="email" />
        </motion.div>
        <motion.div variants={fadeIn('right',0.7)} initial="hidden" whileInView={'show'} viewport={{once:false, amount:0.3}} className='contact-form-container'>
    ...
    {
            showPopup&&(
              <motion.div variants={fadeIn('right',0.5)} initial="hidden" whileInView={'show'} viewport={{once:false, amount:0.3}} className="popup-animation">
