        ...
        <div className="">
            <div className="banner-container">
                <div>
                    ...
                    <motion.div variants={fadeIn('up',0.4)} initial="hidden" whileInView={'show'} viewport={{once:false, amount:0.7}} className="role-box"><span className="role-txt">I am a </span><span className="role"><TypeAnimation sequence={['Web Developer',2000,'Mern Stack Developer',2000]} speed={50} className="animated-text" wrapper="span" repeat={Infinity}/></span></motion.div>
                    </div>
                    ...
                    <motion.div variants={fadeIn('up',0.7)} initial="hidden" whileInView={'show'} viewport={{once:false, amount:0.7}}>
                        ...
                        <a href="https://www.linkedin.com/in/yogesh-d-69b6691ab" target="_blank" rel="noreferrer"><FaLinkedin className="social-icon"/></a>
                    </motion.div>
                </div>
                    <motion.div variants={fadeIn('down',0.5)} initial="hidden" whileInView={'show'} className="image"><img src={require('../../assets/yogesh.png')} alt="yogesh" className="profile" /></motion.div>
            </div>
        </div>
        </>
    )
